...
<body>
    <div class="container">
         ...
         <form action="${pageContext.request.contextPath}/Approve/doCreate" method="post" id="approveInsertForm" class="form-horizontal">
            <fieldset>
               <legend >
                    <label >
                ...
                <div class="form-group" id="userIdDiv">
                    <label class="control-label col-sm-3" for="userId">用户ID</label>
                    <div class="col-sm-5">
                        <input type="text" name="userId" id="userId" class="form-control" 
                               placeholder="请输入用户ID" >
                    </div>
                    <span class="col-sm-4" id="userIdMsg"></span>
                </div>
