...
<head>
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath}/js/approve_list.js"></script>
      ...
      <div id="content">
          ...
          <div class="m-right">
			   <div class="main container">
			      ...
			      <div id="approveDiv">
			           <table border="1" id="approveTab" class="table table-hover table-bordered">
			              <thead>
				              <tr class="success">
				                 <td>编号</td>
				                 <td>项目名称</td>
