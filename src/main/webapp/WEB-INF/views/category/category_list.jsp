...
<head>
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath}/js/category_list.js"></script>
      ...
      <div id="content">
          ...
          <div class="m-right">
			   <div class="main container">
			      ...
			      <div id="categoryDiv">
			           <table border="1" id="categoryTab" class="table table-hover table-bordered">
			              <thead>
				              <tr class="success">
				                 <td>编号</td>
				                 <td>名称</td>
