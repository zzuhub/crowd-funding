...
<head>
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath}/js/photo_list.js"></script>
      ...
      <div id="content">
          ...
          <div class="m-right">
			   <div class="main container">
			      ...
			      <div id="photoDiv">
			           <table border="1" id="photoTab" class="table table-hover table-bordered">
			              <thead>
				              <tr class="success">
				                 <td>图片编号</td>
				                 <td>项目标题</td>
