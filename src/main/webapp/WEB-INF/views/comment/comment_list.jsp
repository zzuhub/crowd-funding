...
<head>
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath}/js/comment_list.js"></script>
      ...
      <div id="content">
          ...
          <div class="m-right">
			   <div class="main container">
			      ...
			      <div id="commentDiv">
			           <table border="1" id="commentTab" class="table table-hover table-bordered">
			              <thead>
				              <tr class="success">
				                 <td>评论编号</td>
				                 <td>用户名称</td>
