...
<body>
    <div class="container">
         ...
         <form action="${pageContext.request.contextPath}/Comment/doUpdate" method="post" id="commentEditForm" class="form-horizontal">
            <!-- 评论ID -->
            <input type="hidden" id="commentId" name="commentId" value="${comment.commentId}">
            <!-- 项目ID -->
            <input type="hidden" id="projectId" name="projectId" value="${comment.project.projectId}">
            <!-- 用户ID -->
            <input type="hidden" id="userId" name="userId" value="${comment.user.userId}">
            <fieldset>
               <legend >
                    <label >
