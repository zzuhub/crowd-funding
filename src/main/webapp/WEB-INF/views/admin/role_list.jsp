...
<head>
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath}/js/role_list.js"></script>
      ...
      <div id="content">
          ...
          <div class="m-right">
			   <div class="main container">
			      ...
			      <div id="roleDiv">
			           <table border="1" id="roleTab" class="table table-hover table-bordered">
			              <thead>
				              <tr class="success">
				                 <td>角色编号</td>
				                 <td>角色名称</td>
