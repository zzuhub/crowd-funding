...
<head>
   ...
   <script type="text/javascript" src="${pageContext.request.contextPath}/js/permission_list.js"></script>
          ...
          <div class="m-right">
			   <div class="main container">
			       ...
			       <form class="form-horizontal" role="form">
			           <div class="form-group">
			              <div id="searchDiv">
			                 ...
			                 <div class="col-sm-4" id="butDiv"></div>
			                 <div class="col-sm-1">
			                 </div>
			              </div>
			           </div>
			      ...
			      <div id="permissionDiv">
			           <table border="1" id="permissionTab" class="table table-hover table-bordered">
			              <thead>
				              <tr class="success">
				                 <td>权限编号</td>
				                 <td>权限名称</td>
